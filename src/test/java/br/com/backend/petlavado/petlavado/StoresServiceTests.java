...
class StoreServiceTest {
    ...
    void testCreateStore() {
        StoreDto storeDto = new StoreDto("Test Store", "test@store.com", "password", "123456789", "12345678901234");
        when(storeRepository.findByEmail(storeDto.email())).thenReturn(null);
        Store store = new Store(storeDto.storeName(), storeDto.email(), storeDto.password(), storeDto.phoneNumber(), storeDto.cnpj());
    ...
    void testFindAll() {
        ...
        when(storeRepository.findAll()).thenReturn(Arrays.asList(
                new Store("Store1", "store1@test.com", "password", "123456789", "12345678901234"),
                new Store("Store2", "store2@test.com", "password", "123456789", "12345678901235")
        ));
    ...
    void testDeleteStore() {
        ...
        Store store = new Store("Test Store", "test@store.com", "password", "123456789", "12345678901234");
